...
const Editor = () => {
    ...
    return (_jsx(MainLayout, { children: _jsx(EditorContainer, { children: _jsxs(MainContent, { children: [_jsx(TopBar, { children: _jsx(IconButton, { onClick: handleBack, children: _jsx(ArrowBackIcon, {}) }) }), _jsx(ContentContainer, { children: _jsx(EditorWrapper, { children: isLoading ? (_jsx(Box, { sx: { display: 'flex', justifyContent: 'center', p: 4 }, children: _jsx(CircularProgress, {}) })) : (_jsxs(_Fragment, { children: [_jsx(TitleContainer, { children: _jsx(TitleInput, { variant: "standard", placeholder: "Sin t\u00EDtulo", value: title, onChange: handleTitleChange, fullWidth: true }) }), content !== null && (_jsx(BlockNoteEditor, { content: content, onChange: handleContentChange }))] })) }) })] }) }) }));
};
